...
public class ClinicResponseDTO {
	...
	public ClinicResponseDTO(long clinicId, String clinicName, String clinicContact, String clinicAddress,
			String clinicDepartment, List<DoctorSchdule> doctorSchdule, List<Staff> staff) {
		super();
